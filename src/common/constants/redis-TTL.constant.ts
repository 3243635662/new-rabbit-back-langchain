...
export const RedisTTL = {
  ...
  CACHE: {
    ...
    // *库存模块 (Inventory)
    // *═══════════════════════════════════════════════════════
    INVENTORY_LIST: 300, // 商家库存列表 (5分钟) - 库存变动较频繁，不宜过长
    INVENTORY_DETAIL: 300, // 库存详情 (5分钟)
    INVENTORY_STATS: 600, // 库存统计 (10分钟) - 出入库统计变化相对慢一些

    // *═══════════════════════════════════════════════════════
    // *财务模块 (Finance)
    // *═══════════════════════════════════════════════════════
    FINANCE_SOURCE_LIST: 300, // 财务资源列表 (5分钟)
    FINANCE_SOURCE_DETAIL: 300, // 财务资源详情 (5分钟)
  },
